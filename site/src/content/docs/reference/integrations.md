...
Run `codegraph install` and pick your agent(s); see [Installation](/forge-codegraph/getting-started/installation/) for the non-interactive flags.

## Manual setup

If you'd rather wire it up yourself, install the CLI:
