...
/**
 * Append a `[X.Y.Z]: https://github.com/bridgenext/forge-codegraph/releases/tag/vX.Y.Z`
...
function appendLinkRef(text, version) {
  const refLine = `[${version}]: https://github.com/bridgenext/forge-codegraph/releases/tag/v${version}`;
