'use strict';
//
// Programmatic / embedded SDK entry for @bridgenext/codegraph (issue #354).
//
...
// API — `require("@bridgenext/codegraph")` returning the CodeGraph class et al.
//
// The compiled library + its production dependencies (web-tree-sitter,
// tree-sitter-wasms, …) ship INSIDE the per-platform bundle, at
//   @bridgenext/codegraph-<platform>-<arch>/lib/dist/index.js
...
var pkg = '@bridgenext/codegraph-' + target;
